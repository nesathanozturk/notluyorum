...
const NoteCard = () => {
  const renderedNoteCard = notes.map((note) => (
    <div
      key={note.id}
      className={`bg-[${note.cardColor}] py-5 px-6 mb-6 md:max-w-[25rem] rounded-3xl cursor-pointer`}
    >
      ...
      <div className="flex justify-between items-center flex-wrap gap-2 text-[#D9DEF2] font-bold uppercase mt-7 text-sm">
